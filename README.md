This is a particle simulation written in rust, rendered with the macroquad library. It follows a set of simple rules to create interesting emergent behavior. 
